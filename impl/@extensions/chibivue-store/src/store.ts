...
import { type StateTree, type Store, activeStore, setActiveStore, storeSymbol } from "./rootStore";

export function defineStore<Id extends string>(id: Id, setup: () => StateTree): () => StateTree {
