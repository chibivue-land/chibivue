...
<KawaikoNote variant="funny" title="实例的作用">

组件的“蓝图”和“实例”是两回事。即使连续放置三个相同的 CounterComponent，每个实例也会拥有彼此独立的状态！
...
<KawaikoNote variant="surprise" title="组件系统完成！">

现在你已经可以把 UI 组件化了！这套机制在实际应用开发中不可或缺。
