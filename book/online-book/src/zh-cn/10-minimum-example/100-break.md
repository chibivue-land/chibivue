...
恭喜你完成 Minimum Example 部分！现在你已经亲手体验了 Vue.js 的核心组成部分。
...
<KawaikoNote variant="funny" title="真正的旅程由此开始！">

凭借目前掌握的知识，你已经能够阅读 Vue.js 源码了。可以前往自己感兴趣的章节，也可以直接深入原始代码，请按自己的方式享受探索过程！
