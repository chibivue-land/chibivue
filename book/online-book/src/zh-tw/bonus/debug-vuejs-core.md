...
作為本書方法的一部分，我們強烈建議閱讀和理解原始碼，以及進行原始碼閱讀和測試實驗。

因此，我們將介紹幾種除錯原始碼的方法，這些方法在正文中沒有涉及。

（我們將按照易於理解的順序介紹它們。）

## 利用 SFC Playground

這是最簡單的方法。它廣為人知，甚至在官方檔案中也有連結。

https://play.vuejs.org

在這個 playground 中，您不僅可以編寫 Vue 元件並檢查它們的行為，還可以檢查 SFC 的編譯結果。
