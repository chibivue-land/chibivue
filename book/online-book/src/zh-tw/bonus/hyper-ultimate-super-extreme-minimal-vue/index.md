...
所以，在這個附錄中，我將嘗試在"**15 分鐘**"內實作它。

當然，我也會將解釋限制在一頁內。

此外，不僅是頁面，"實作本身將包含在一個檔案中"也是我將嘗試實作的目標。

但是，即使是一個檔案，在一個檔案中寫 100,000 行也是沒有意義的，所以我將目標是在少於 150 行內實作它。
...
雖然我現在將以一種非常草率的方式實作它，但我將這種草率比作一個"氣球"，即使針碰到它也會爆炸。

:::

## 你只是要實作一個響應式系統，對吧？

不，不是這樣的。這次，我將嘗試列出將在 15 分鐘內實作的內容。
